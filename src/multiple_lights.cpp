...
void compute_light_position(float t, scene_environment_with_multiple_lights& environment)
{
	...
	environment.spotlight_color[0] = { 1.0f, 0.9f, 0.0f };
	environment.spotlight_position[0] = {15,5,2.5};

	environment.spotlight_color[1] = { 1.0f, 0.9f, 0.0f };
	environment.spotlight_position[1] = {15,-5,2.5};

	environment.spotlight_color[2] = { 1.0f,0.0f,0.0f };
	environment.spotlight_position[2] = {-15,5,2.5 };

	environment.spotlight_color[3] = { 1.0f,0.0f,0.0f };
	environment.spotlight_position[3] = {-15,-5,2.5};

}

void light_shape_drawable::initialize(GLuint shader_multiple_lights)
{
	float const radius_sphere = 0.001f; // Adapt the radius of the spotlight as you wish
